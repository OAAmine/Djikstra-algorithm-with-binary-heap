...
int main() {
    ...
    graphe_ajouter_arc(&g, 0, 1, -2.3);
    graphe_ajouter_arc(&g, 1, 2, -1.);
    graphe_ajouter_arc(&g, 1, 2, 5.2);
    graphe_ajouter_arc(&g, 1, 2, -7.1);
    graphe_ajouter_arc(&g, 1, 1, 1.3);
    graphe_ajouter_arc(&g, 3, 0, .5);
    graphe_ajouter_arc(&g, 3, 0, 1.9);
	...
	printf("graphe_supprimer_arc(&g, %d, %d, %f) renvoie %d\n", 0, 1, 3.7, graphe_supprimer_arc(&g, 0, 1, 3.7));
	printf("graphe_supprimer_arc(&g, %d, %d, %f) renvoie %d\n", 0, 1, 3.7, graphe_supprimer_arc(&g, 0, 1, 3.7));
	printf("graphe_supprimer_arc(&g, %d, %d, %f) renvoie %d\n", 0, 1, 18.1, graphe_supprimer_arc(&g, 0, 1, 18.1));
	printf("graphe_supprimer_arc(&g, %d, %d, %f) renvoie %d\n", 1, 0, 18., graphe_supprimer_arc(&g, 1, 0, 18.));
	printf("graphe_supprimer_arc(&g, %d, %d, %f) renvoie %d\n", 1, 2, 5.2, graphe_supprimer_arc(&g, 1, 2, 5.2));
	printf("graphe_supprimer_arc(&g, %d, %d, %f) renvoie %d\n", 3, 0, 1.9, graphe_supprimer_arc(&g, 3, 0, 1.9));
	printf("graphe_supprimer_arc(&g, %d, %d, %f) renvoie %d\n", 0, 4, 2.1, graphe_supprimer_arc(&g, 0, 4, 2.1));
